========================================================================
    ПРИЛОЖЕНИЕ : Обзор проекта поточечное рисование
========================================================================

Это приложение поточечное рисование создано автоматически с помощью мастера 
приложений.  

Здесь приведены краткие сведения о содержимом каждого из файлов, использованных 
при создании приложения поточечное рисование.

поточечное рисование.vcxproj
...
поточечное рисование.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) с именем поточечное рисование.pch и файла предкомпилированных типов 
    с именем StdAfx.obj.
